...
namespace Ai.Hong.Controls
{
    ...
    /// 附带颜色、选择的列表
    /// </summary>
    public partial class FlattenSelectColorList : UserControl
    {
        /// <summary>
        /// 列表选择消息
        /// </summary>
        public static readonly RoutedEvent ItemSelectedEvent = EventManager.RegisterRoutedEvent("ItemSelected",
                RoutingStrategy.Bubble, typeof(SelectionChangedEventHandler), typeof(FlattenSelectColorList));
        /// <summary>
        /// 列表选择消息
        /// </summary>
